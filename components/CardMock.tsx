  ...
  return (
    <div className="w-full max-w-sm">
      <div className="card p-0 overflow-hidden">
        <div className="bg-gradient-to-br from-sky-400 to-emerald-600 text-white p-5">
          <div className="flex justify-between items-center">
            <div className="font-bold text-sm">WILLIAMSHOLDINGS</div>
          ...
          <div className="mt-6 text-lg tracking-[2px]">
            **** **** **** {last4}
          </div>
